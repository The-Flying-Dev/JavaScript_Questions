...
# a parameter that has an existing value at the time of the method call / 
# a parameter that is given a value at the time of the method definition
# a parameter that initialized with a default value during a method definition
